...
/**
 * Configuration class for this application. Describes what this Pi actor does and how to use it.
 *
...
public class PiActorConfig {
  ...
  /**
   * Location for this Pi Actor. This should be a short string that describes the geographical
   * (physical) area that this Pi assists in managing.
   */
   ...
   */
  public PiActorConfig(String piName, String location, String docussandraUrl,
      ArrayList<ActorAbility> abilities) {
    this.piName = piName;
    if (location != null) {
  ...
  /**
   * Builds a config object from a config String. String should be in the format of:" $NAME_OF_ACTOR
   * $Ability_Config_from_ActorAbility. ... Line comments (#) are allowed. (Must be the first
  ...
  public static PiActorConfig buildConfigFromString(String in) throws IllegalArgumentException {
    try {
      ...
      throw new IllegalArgumentException(
          "Input config string was not in the expected format. Your input was: \n" + in);

    }
  }

  /**
   * Builds a config object from a config File. File should be in the format of:" $NAME_OF_ACTOR
   * $Ability_Config_from_ActorAbility. ... Line comments (#) are allowed. (Must be the first
   * character of the line.) "
   *
   ...
   */
  public static PiActorConfig buildConfigFromFile(File configFile)
  ...
  public String toString() {
    return "PiActorConfig{" + "piName=" + piName + ", location=" + location + ", docussandraUrl="
        + docussandraUrl + ", abilities=" + abilities + '}';
  }
  ...
  /**
   * Location for this Pi Actor. This should be a short string that describes the geographical area
   * that this Pi assists in managing.
   *
   * @return the location
   */
